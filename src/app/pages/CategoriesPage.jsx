...
import { createCategory, DEFAULT_COLORS } from '../../core/model.js';
import { canReparent, descendantIds, flattenTree, pathOf } from '../../core/categories.js';
import { useStore } from '../state/StateProvider.jsx';
import { money } from '../format.js';
import { IconEmpty, IconPlus, IconTrash } from '../components/Icons.jsx';
...
export default function CategoriesPage() {
  ...
  const [draft, setDraft] = useState({ name: '', parentId: '', color: null });
  ...
  const netOf = (id) => stats.byCategory.find((b) => b.categoryId === id)?.net ?? 0;

  const patch = (id, field, value) => update((d) => {
