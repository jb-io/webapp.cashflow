 ...
 */
import { currentYearView, viewFromMonths } from '../../core/model.js';
import { monthKey, monthSpan, today } from '../../core/dateUtils.js';
...
export default function PeriodPicker() {
  ...
  const move = (months) => setView({ from: shift(view.from, months), to: shift(view.to, months) });
