...
export const IconPower = (p) => (<svg {...base} {...p}><path d="M12 4v8" /><path d="M7.5 6.8a7 7 0 109 0" /></svg>);
...
export const IconChevronLeft = (p) => (<svg {...base} {...p}><path d="M14 6l-6 6 6 6" /></svg>);
export const IconChevronRight = (p) => (<svg {...base} {...p}><path d="M10 6l6 6-6 6" /></svg>);
